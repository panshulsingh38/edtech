    ...
    <>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-10 pb-6 border-b border-nord-3 gap-4">
        <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-4 mr-4">
              <button
                ...
                className={cn(
                  ...
                  isHighContrast ? "bg-yellow-500/20 text-yellow-400 border border-yellow-500/50" : "bg-nord-1/50 text-nord-4 border border-nord-3 hover:text-white"
                )}
              >
              ...
              <button
                ...
                className={cn(
                  ...
                  isSprintMode ? "bg-nord-8" : "bg-gray-600"
                )}
              >
                <span
                  className={cn(
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-nord-6">
            {testData.testTitle}
          </h2>
          {mode === 'test' && (
            <div className="flex items-center gap-2 bg-nord-8/20 text-nord-8 px-4 py-2 rounded-full border border-nord-8/30 font-mono text-xl shadow-lg">
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-end gap-3 print:hidden w-full md:w-auto">
          <div className="flex items-center bg-nord-1 rounded-full p-1 mr-4 border border-nord-3">
            <button
              ...
              className={cn(
                ...
                mode === 'test' ? "bg-nord-8 text-white shadow-lg" : "text-nord-4 hover:text-white"
              )}
            >
            ...
            <button
              ...
              className={cn(
                "flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200",
                mode === 'flashcards' ? "bg-nord-8 text-white shadow-lg" : "text-nord-4 hover:text-white"
              )}
            >
            ...
            <button
              ...
              className={cn(
                "flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200",
                mode === 'mindmap' ? "bg-nord-8 text-white shadow-lg" : "text-nord-4 hover:text-white"
              )}
            >
          ...
          <div className="relative print:hidden flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-nord-12/20 hover:bg-nord-12/30 border border-nord-12/30 text-nord-12 font-bold transition-all duration-200 shadow-lg shadow-nord-12/10 hover:scale-105"
            >
            ...
            <button 
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-nord-8/20 hover:bg-nord-8/30 border border-nord-8/30 text-nord-8 font-medium transition-all duration-200"
            >
                ...
                >
                  <div className="p-1">
                    <button 
                      ...
                      className="flex items-center w-full px-4 py-2.5 text-sm text-nord-5 hover:text-white hover:bg-nord-1/50 rounded-lg transition-colors text-left"
                    >
          ...
          <button 
            onClick={onReset}
            className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-nord-1/50 hover:bg-nord-2/50 border border-nord-3 text-white font-medium transition-all duration-200"
          >
      ...
      {showResults && mode === 'test' && (
        <motion.div 
          ...
          className="mb-12 p-[1px] rounded-3xl bg-nord-3"
        >
          <div className="bg-[#13131a] rounded-[23px] p-8 md:p-12 text-center relative overflow-hidden">
            
            <h3 className="text-2xl font-bold text-nord-5 mb-4 relative z-10">Your Performance</h3>
              ...
              <motion.div 
                ...
                className={cn(
                  ...
                  showResults 
                    ...
                    : 'bg-nord-1/50 border-white/5 hover:border-nord-3'
                )}
              >
                <div className="flex flex-col mb-6">
                  <div className="flex items-start justify-between gap-6">
                    <div className="flex items-start gap-6 flex-1">
                      <span className="flex items-center justify-center bg-nord-8/20 text-nord-8 font-bold rounded-xl w-12 h-12 shrink-0 text-xl border border-nord-8/20">
                        {index + 1}
                      </span>
                      ...
                      {(q.type === 'mcq' || q.type === 'short_answer') && (
                        <button
                          ...
                          className={cn(
                            ...
                            showWhiteboard[q.id] 
                              ? "bg-nord-9/20 text-purple-300 border-nord-9/30 hover:bg-nord-9/30" 
                              : "bg-nord-1/50 text-nord-4 border-nord-3 hover:bg-nord-2/50 hover:text-white"
                          )}
                        >
                  ...
                  {hints[q.id] && (
                    <div className="ml-[4.5rem] mt-4 p-4 bg-yellow-500/5 border border-yellow-500/20 rounded-xl">
                      ...
                      {hints[q.id].loading ? (
                        ...
                        <div className="text-nord-5 prose prose-invert text-sm">{hints[q.id].text}</div>
                      )}
                    </div>
                  )}
                  ...
                  {analogies[q.id] && (
                    <div className="ml-[4.5rem] mt-4 p-4 bg-emerald-500/5 border border-emerald-500/20 rounded-xl">
                      ...
                      {analogies[q.id].loading ? (
                        ...
                        <div className="text-nord-5 prose prose-invert text-sm"><Latex>{analogies[q.id].text}</Latex></div>
                      )}
                    </div>
                  )}
                  ...
                  {!showResults && isAnswered && (
                    <motion.div 
                      ...
                      className="ml-[4.5rem] mt-4 flex items-center gap-4 bg-nord-1/50 p-3 rounded-xl border border-nord-3"
                    >
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className={cn("px-3 py-1.5 rounded-lg text-sm font-medium transition-colors", confidence === 1.0 ? "bg-green-500/20 text-green-300 border border-green-500/30" : "bg-nord-1/50 text-nord-4 hover:bg-nord-2/50 border border-transparent")}
                        >
                          Certain
                        </button>
                        <button
                          ...
                          className={cn("px-3 py-1.5 rounded-lg text-sm font-medium transition-colors", confidence === 0.5 ? "bg-yellow-500/20 text-yellow-300 border border-yellow-500/30" : "bg-nord-1/50 text-nord-4 hover:bg-nord-2/50 border border-transparent")}
                        >
                          Unsure
                        </button>
                        <button
                          ...
                          className={cn("px-3 py-1.5 rounded-lg text-sm font-medium transition-colors", confidence === 0.0 ? "bg-red-500/20 text-red-300 border border-red-500/30" : "bg-nord-1/50 text-nord-4 hover:bg-nord-2/50 border border-transparent")}
                        >
                          Guess
                        </button>
                      </div>
                  ...
                  <div className="space-y-3 ml-[4.5rem]">
                    {q.options.map((option, optIdx) => {
                      ...
                      if (showCorrectHighlight) {
                        ...
                        labelClass += "bg-nord-8/20 border-nord-8 text-white shadow-lg";
                      } else {
                        labelClass += "bg-nord-1/50 border-transparent hover:bg-nord-2/50 text-nord-5 hover:text-white";
                      }
                ...
                {(q.type === 'short_answer' || q.type === 'reverse_construction') && (
                  <div className="ml-[4.5rem]">
                    {q.type === 'reverse_construction' && (
                      <div className="mb-4 p-4 bg-nord-12/10 border border-nord-12/30 rounded-xl text-orange-200">
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        className="w-full bg-nord-1/50 border border-nord-3 rounded-xl p-4 text-white placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all pr-12"
                      />
                      {!showResults && (
                        <button
                          type="button"
                          ...
                          className={cn(
                            ...
                            recordingId === q.id 
                              ...
                              : "bg-nord-1/50 text-nord-4 hover:text-white hover:bg-nord-2/50"
                          )}
                        >
                    ...
                    {showResults && (
                      ...
                      >
                        {isGrading && !gradingResults[q.id] ? (
                          <div className="flex items-center gap-3 p-4 rounded-xl bg-nord-8/10 border border-nord-8/20 text-nord-8">
                          ...
                          <div className={cn(
                            ...
                            <p className="text-nord-5 leading-relaxed">{gradingResults[q.id].feedback}</p>
                          </div>
                        ) : null}
                      </motion.div>
                    )}
                ...
                {q.type === 'estimation' && (
                  <div className="ml-[4.5rem] mt-4">
                    <div className="bg-nord-1/50 border border-nord-3 rounded-xl p-6">
                      <h4 className="text-sm font-bold text-nord-8 mb-6 uppercase tracking-wider text-center">Order of Magnitude</h4>
                      <div className="flex items-center gap-4">
                        ...
                        <input
                          ...
                          onChange={(e) => handleOptionChange(q.id, e.target.value)}
                          disabled={showResults}
                          className="flex-1 h-2 bg-nord-3 rounded-lg appearance-none cursor-pointer accent-indigo-500 disabled:opacity-50"
                        />
                        <span className="text-nord-4 font-mono text-sm">10<sup>15</sup></span>
                      </div>
                      <div className="mt-6 text-center">
                        <span className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-nord-8/20 border border-nord-8/30 text-nord-8 font-mono text-xl">
                  ...
                  >
                    <div className={cn(
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              playingAudioId === q.id 
                                ? "bg-nord-8/20 text-nord-8 border-nord-8/50" 
                                : "bg-nord-1/50 text-nord-4 hover:text-white hover:bg-nord-2/50 border-nord-3"
                            )}
                          >
                        ...
                        <p className="text-nord-5 leading-relaxed prose prose-invert max-w-none"><Latex>{q.explanation}</Latex></p>
                        
                        {/* Multi-Step Breakdown UI */}
                        {q.steps && q.steps.length > 0 && (
                          <div className="mt-6 space-y-4">
                            <h4 className="text-sm font-bold tracking-wider uppercase text-nord-8 mb-2">Step-by-Step Breakdown</h4>
                            {q.steps.map((step: any) => (
                              <div key={step.stepNumber} className={cn("p-4 rounded-lg border", q.flawIndex === step.stepNumber ? "bg-red-500/10 border-red-500/30" : "bg-nord-1/50 border-nord-3")}>
                                <div className="flex items-center gap-2 mb-2">
                                  <span className="flex items-center justify-center w-6 h-6 rounded-full bg-nord-8/20 text-nord-8 text-xs font-bold">{step.stepNumber}</span>
                                ...
                                <div className="text-sm text-nord-5 mb-2 prose prose-invert max-w-none"><Latex>{step.logicalDeduction}</Latex></div>
                                {step.equation && (
                    ...
                    {isGraded && !isCorrect && (
                      <div className="mt-4 flex justify-end">
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-nord-9/20 text-purple-300 hover:bg-nord-9/30 transition-all text-sm font-bold border border-nord-9/30"
                        >
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-nord-8/20 flex items-center justify-center border border-nord-8/30">
                <span className="text-nord-8 font-bold">{Object.keys(answers).length}</span>
              </div>
            ...
            <button 
              type="submit" 
              className="w-full sm:w-auto flex items-center justify-center gap-2 text-white bg-nord-8 hover:bg-nord-8 font-semibold rounded-xl text-lg px-10 py-4 transition-all duration-200 hover:scale-[1.02] hover:shadow-xl"
            >
              Submit Assessment
