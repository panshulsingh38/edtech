    ...
    <>
      ...
      {showBlurWarning && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-[#1a1a24] border border-red-500/30 p-8 rounded-3xl max-w-md w-full shadow-2xl text-center relative overflow-hidden">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-1 bg-gradient-to-r from-red-500 to-orange-500" />
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-10 pb-6 border-b border-white/10 gap-4">
        <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-4 mr-4">
              <button
                ...
                className={cn(
                  ...
                  isHighContrast ? "bg-yellow-500/20 text-yellow-400 border border-yellow-500/50" : "bg-white/5 text-gray-400 border border-white/10 hover:text-white"
                )}
              >
              ...
              <button
                ...
                className={cn(
                  ...
                  isSprintMode ? "bg-indigo-500" : "bg-gray-600"
                )}
              >
                <span
                  className={cn(
          ...
          {mode === 'test' && (
            <div className="flex items-center gap-2 bg-indigo-500/20 text-indigo-300 px-4 py-2 rounded-full border border-indigo-500/30 font-mono text-xl shadow-[0_0_15px_rgba(99,102,241,0.2)]">
                ...
                <div className="flex flex-col mb-6">
                  ...
                  {hints[q.id] && (
                    <div className="ml-[4.5rem] mt-4 p-4 bg-yellow-500/5 border border-yellow-500/20 rounded-xl">
                      ...
                      {hints[q.id].loading ? (
                        ...
                        <div className="text-gray-300 prose prose-invert text-sm">{hints[q.id].text}</div>
                      )}
                    </div>
                  )}
                  ...
                  {analogies[q.id] && (
                    <div className="ml-[4.5rem] mt-4 p-4 bg-emerald-500/5 border border-emerald-500/20 rounded-xl">
                      ...
                      {analogies[q.id].loading ? (
                        ...
                        <div className="text-gray-300 prose prose-invert text-sm"><Latex>{analogies[q.id].text}</Latex></div>
                      )}
                    </div>
                  )}
                  ...
                  {!showResults && isAnswered && (
                    <motion.div 
                      ...
                      className="ml-[4.5rem] mt-4 flex items-center gap-4 bg-white/5 p-3 rounded-xl border border-white/10"
                    >
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className={cn("px-3 py-1.5 rounded-lg text-sm font-medium transition-colors", confidence === 1.0 ? "bg-green-500/20 text-green-300 border border-green-500/30" : "bg-white/5 text-gray-400 hover:bg-white/10 border border-transparent")}
                        >
                          Certain
                        </button>
                        <button
                          ...
                          className={cn("px-3 py-1.5 rounded-lg text-sm font-medium transition-colors", confidence === 0.5 ? "bg-yellow-500/20 text-yellow-300 border border-yellow-500/30" : "bg-white/5 text-gray-400 hover:bg-white/10 border border-transparent")}
                        >
                          Unsure
                        </button>
                        <button
                          ...
                          className={cn("px-3 py-1.5 rounded-lg text-sm font-medium transition-colors", confidence === 0.0 ? "bg-red-500/20 text-red-300 border border-red-500/30" : "bg-white/5 text-gray-400 hover:bg-white/10 border border-transparent")}
                        >
                          Guess
                        </button>
                      </div>
                ...
                {(q.type === 'short_answer' || q.type === 'reverse_construction') && (
                  <div className="ml-[4.5rem]">
                    {q.type === 'reverse_construction' && (
                      <div className="mb-4 p-4 bg-orange-500/10 border border-orange-500/30 rounded-xl text-orange-200">
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl p-4 text-white placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all pr-12"
                      />
                      {!showResults && (
                        <button
                          type="button"
                ...
                {q.type === 'estimation' && (
                  <div className="ml-[4.5rem] mt-4">
                    <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                      <h4 className="text-sm font-bold text-indigo-400 mb-6 uppercase tracking-wider text-center">Order of Magnitude</h4>
                      <div className="flex items-center gap-4">
                        <span className="text-gray-400 font-mono text-sm">10<sup>-5</sup></span>
                        <input
                          type="range"
                          min="-5"
                          max="15"
                        ...
                        />
                        <span className="text-gray-400 font-mono text-sm">10<sup>15</sup></span>
                      </div>
                      <div className="mt-6 text-center">
                        <span className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-indigo-500/20 border border-indigo-500/30 text-indigo-300 font-mono text-xl">
                    ...
                    <div className={cn(
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm font-bold tracking-wider uppercase text-gray-400 block">AI Explanation</span>
                          <button
                        ...
                        <p className="text-gray-300 leading-relaxed prose prose-invert max-w-none"><Latex>{q.explanation}</Latex></p>
                        
                        {/* Multi-Step Breakdown UI */}
                        {q.steps && q.steps.length > 0 && (
                          <div className="mt-6 space-y-4">
                            <h4 className="text-sm font-bold tracking-wider uppercase text-indigo-400 mb-2">Step-by-Step Breakdown</h4>
                            {q.steps.map((step: any) => (
                              <div key={step.stepNumber} className={cn("p-4 rounded-lg border", q.flawIndex === step.stepNumber ? "bg-red-500/10 border-red-500/30" : "bg-white/5 border-white/10")}>
                                <div className="flex items-center gap-2 mb-2">
                                  <span className="flex items-center justify-center w-6 h-6 rounded-full bg-indigo-500/20 text-indigo-300 text-xs font-bold">{step.stepNumber}</span>
                                ...
                                <div className="text-sm text-gray-300 mb-2 prose prose-invert max-w-none"><Latex>{step.logicalDeduction}</Latex></div>
                                {step.equation && (
                                  <div className="bg-black/30 p-3 rounded-lg text-center overflow-x-auto text-indigo-200">
                    ...
                    {isGraded && !isCorrect && (
                      <div className="mt-4 flex justify-end">
                        <button
                          ...
                          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-purple-500/20 text-purple-300 hover:bg-purple-500/30 transition-all text-sm font-bold border border-purple-500/30"
                        >
