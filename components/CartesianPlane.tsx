...
export default function CartesianPlane({ onCoordinateSelect, disabled, correctAnswer, selectedCoordinate }: CartesianPlaneProps) {
  ...
  return (
    <div className="flex flex-col items-center">
      <div 
        className="relative bg-white/5 border-2 border-white/20 rounded-xl overflow-hidden cursor-crosshair shadow-lg"
      ...
      >
        ...
        {selectedCoordinate && (
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            className="absolute w-4 h-4 bg-indigo-500 rounded-full -translate-x-1/2 -translate-y-1/2 border-2 border-white shadow-[0_0_10px_rgba(99,102,241,0.8)]"
