    ...
    <div className="w-full aspect-[4/3] md:aspect-[3/2] perspective-1000 relative">
      ...
      >
        ...
        >
          ...
          {spokenAnswer && (
            <div className="absolute bottom-16 w-full px-8 text-white text-sm font-medium italic truncate">
              "{spokenAnswer}"
            </div>
          )}
        ...
        >
          ...
          <div className="w-full h-full flex flex-col items-center justify-center overflow-y-auto py-10 px-2 mt-4 mb-8 custom-scrollbar">
            <h4 className="text-xs font-bold tracking-widest uppercase text-white mb-3 shrink-0">Correct Answer</h4>
