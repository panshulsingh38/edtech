        ...
        <nav className="flex items-center gap-4">
          ...
          <Link 
            ...
            className={pathname?.startsWith('/dashboard') 
              ? "flex items-center gap-2 bg-nord-8/20 border border-nord-8/30 text-white px-4 py-2 rounded-full text-sm font-medium transition-all" 
              : "flex items-center gap-2 bg-nord-1 hover:bg-nord-2 border border-nord-3 text-nord-4 hover:text-white px-4 py-2 rounded-full text-sm font-medium transition-all"}
          >
          ...
          {mounted && (
            <button
              ...
              className="p-2 rounded-full bg-nord-1 hover:bg-nord-2 border border-nord-3 text-nord-4 hover:text-white transition-all ml-2"
            >
