...
export default function SprintTimer({ initialTime, isActive, onTimeUp, timeDelta }: SprintTimerProps) {
  ...
  return (
    <div className={`relative flex items-center gap-2 px-4 py-2 rounded-full font-mono text-xl border-2 shadow-lg transition-colors duration-300 ${isDanger ? 'bg-red-500/20 border-red-500 text-red-400' : 'bg-indigo-900/50 border-nord-8/30 text-white'}`}>
