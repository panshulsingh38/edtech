  ...
  return (
    <div className="bg-[#13131a]/80 backdrop-blur-xl border border-nord-3 rounded-3xl p-6 w-full max-w-sm shadow-2xl relative overflow-hidden">
      ...
      <div className={cnlocal(
        ...
        mode === 'focus' ? "bg-nord-8" : "bg-emerald-500"
      )} />
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        {/* Mode Switcher */}
        <div className="flex bg-nord-1/50 rounded-full p-1 border border-nord-3 mb-6 w-full">
          <button
            onClick={() => switchMode('focus')}
            className={cnlocal(
              "flex-1 py-1.5 rounded-full text-xs font-bold transition-all flex items-center justify-center gap-2",
              mode === 'focus' ? "bg-nord-8 text-white shadow-md" : "text-nord-4 hover:text-white"
            )}
          >
        ...
        <div className="relative w-48 h-48 flex items-center justify-center mb-6">
          ...
          <div className="text-center">
            ...
            <div className={cnlocal(
              ...
              mode === 'focus' ? "text-nord-8" : "text-emerald-400"
            )}>
        ...
        <div className="flex flex-col items-center gap-4 w-full">
          <div className="flex items-center gap-4">
            <button
              ...
              className={cnlocal(
                ...
                isMusicPlaying ? "bg-nord-15/20 text-nord-15 border-nord-15/50" : "bg-nord-1/50 text-nord-4 hover:text-white"
              )}
              title="Toggle Music"
            >
            ...
            <button
              ...
              className={cnlocal(
                ...
                mode === 'focus' ? "bg-nord-8 hover:bg-nord-8" : "bg-emerald-600 hover:bg-emerald-500"
              )}
            >
            ...
            <button
              onClick={resetTimer}
              className="w-10 h-10 rounded-full bg-nord-1/50 border border-nord-3 flex items-center justify-center text-nord-4 hover:text-white transition-colors"
              title="Reset Timer"
            >
          ...
          <button 
            onClick={cycleTrack}
            className="text-xs text-gray-500 hover:text-nord-8 transition-colors flex items-center gap-1.5 mt-2"
          >
