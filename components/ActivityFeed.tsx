    ...
    <div className="mb-8">
      <div className="flex items-center justify-between mb-4 mt-16">
        <div>
          ...
          <p className="text-lg text-gray-400">Your recent Snap & Solve and Survival Guide history.</p>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {logs.map((log) => (
          <div 
            ...
            className="group cursor-pointer p-6 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-indigo-500/50 transition-all duration-300 flex flex-col"
          >
            <div className="flex items-start justify-between mb-4">
              <div className={`w-12 h-12 rounded-2xl flex items-center justify-center border ${log.type === 'SNAP_AND_SOLVE' ? 'bg-purple-500/20 border-purple-500/30' : 'bg-orange-500/20 border-orange-500/30'}`}>
