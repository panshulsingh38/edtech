...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-nord-0 text-white overflow-hidden relative selection:bg-nord-8/30 flex items-center justify-center font-sans">
      {/* Background Gradients */}
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-nord-8/10 hidden pointer-events-none" />
      <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-nord-9/10 hidden pointer-events-none" />
      ...
      >
        <div className="p-[1px] rounded-[2rem] bg-gradient-to-b from-white/20 to-white/0 shadow-2xl shadow-indigo-500/10">
          <div className="bg-[#13131a]/90 backdrop-blur-3xl p-10 rounded-[2rem] border border-white/5 flex flex-col items-center text-center">
            ...
            <h1 className="text-4xl font-bold text-nord-6 mb-4 tracking-tight">
            ...
            <div className="mt-8 text-sm text-gray-500 flex items-center justify-center gap-2">
              <span className="w-8 h-[1px] bg-nord-2/50"></span>
              Secured by NextAuth
              <span className="w-8 h-[1px] bg-nord-2/50"></span>
            </div>
          </div>
