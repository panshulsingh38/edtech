    ...
    <div className="min-h-screen bg-black/95 text-white py-12 px-6">
      <div className="max-w-4xl mx-auto space-y-12">
        <header className="text-center space-y-4">
          ...
          <p className="text-xl text-gray-400">Viewing progress for <span className="text-indigo-400 font-semibold">{user.name || "Student"}</span></p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl relative overflow-hidden group">
            ...
            <h3 className="text-gray-400 font-medium mb-2">Tests Generated</h3>
          ...
          <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl relative overflow-hidden group">
            ...
            <p className="text-4xl font-bold text-orange-400">{user.streak} <span className="text-xl text-gray-500 font-normal">days</span></p>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl relative overflow-hidden group">
            ...
            <h3 className="text-gray-400 font-medium mb-2">Insights Remaining</h3>
            <p className="text-4xl font-bold text-purple-400">{user.insights}</p>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-xl relative overflow-hidden group">
            ...
            <h3 className="text-gray-400 font-medium mb-2">Target Exam</h3>
        ...
        <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-3xl p-8 text-center">
          ...
          <Link href="/" className="inline-flex items-center justify-center px-8 py-4 bg-indigo-500 hover:bg-indigo-600 text-white font-bold rounded-xl transition-all shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:shadow-[0_0_30px_rgba(99,102,241,0.5)] hover:-translate-y-1">
            Upgrade Account
          </Link>
        </div>
      </div>
