      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-3">
            <div className="p-3 bg-nord-12/20 rounded-xl border border-nord-12/30 shrink-0">
              <BookOpen className="w-8 h-8 text-nord-12" />
            </div>
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-8">
          ...
          <div className="flex flex-col gap-6">
            <div 
              className="border-2 border-dashed border-zinc-700 hover:border-nord-12/50 bg-zinc-900/50 rounded-2xl p-8 flex flex-col items-center justify-center text-center cursor-pointer transition-all duration-300 min-h-[300px]"
            ...
            >
              ...
              {file ? (
                <div className="flex flex-col items-center gap-4">
                  <div className="w-20 h-20 bg-nord-12/10 rounded-2xl flex items-center justify-center border border-nord-12/20">
                    <FileText className="w-10 h-10 text-nord-12" />
                  </div>
                  <div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-4 px-6 bg-zinc-800 hover:bg-zinc-700 text-nord-12 rounded-xl font-bold flex items-center justify-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed border border-nord-12/20"
            >
          ...
          <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl p-6 lg:p-10 min-h-[500px]">
            <h3 className="text-xl font-bold text-zinc-100 mb-6 flex items-center gap-2 border-b border-zinc-800 pb-4">
              <BookOpen className="w-5 h-5 text-nord-12" />
              Your Survival Guide
            </h3>
            ...
            {!guide && loading ? (
              ...
              <div className="text-zinc-300 leading-relaxed space-y-4 [&>h1]:text-2xl [&>h1]:font-bold [&>h1]:text-white [&>h1]:mt-8 [&>h1]:mb-4 [&>h2]:text-xl [&>h2]:font-bold [&>h2]:text-nord-12 [&>h2]:mt-8 [&>h2]:mb-3 [&>h2]:border-b [&>h2]:border-zinc-800 [&>h2]:pb-2 [&>h3]:text-lg [&>h3]:font-bold [&>h3]:text-white [&>h3]:mt-6 [&>h3]:mb-2 [&>p]:mb-4 [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:mb-4 [&>ol]:list-decimal [&>ol]:pl-6 [&>ol]:mb-4 [&>li]:mb-2 [&>strong]:text-nord-4 [&>code]:bg-zinc-800 [&>code]:text-orange-300 [&>code]:px-1.5 [&>code]:py-0.5 [&>code]:rounded [&>pre]:bg-zinc-950 [&>pre]:p-4 [&>pre]:rounded-lg [&>pre]:overflow-x-auto [&>pre]:mb-4 [&>pre>code]:bg-transparent [&>pre>code]:text-zinc-300 [&>pre>code]:p-0">
