...
export default function Leaderboard() {
  ...
  return (
    <main className="min-h-screen bg-nord-0 text-white p-6 relative selection:bg-nord-14/30">
      ...
      <div className="max-w-4xl mx-auto relative z-10 pt-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-nord-1 border border-nord-3 backdrop-blur-md mb-6">
            ...
            {users.map((user, index) => (
              <motion.div
                ...
                className={cn(
                  ...
                  user.isCurrentUser ? "bg-nord-8/10 border-nord-14/20" : "hover:bg-nord-1"
                )}
              >
                <div className="col-span-2 flex justify-center">
                  {user.rank === 1 ? (
                    ...
                    <div className="w-10 h-10 rounded-full bg-gray-300/20 flex items-center justify-center border border-gray-300/50">
                      <span className="font-bold text-nord-4">2</span>
                    </div>
                  ) : user.rank === 3 ? (
                ...
                <div className="col-span-6 flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-nord-14/30 to-purple-500/30 border border-nord-3 flex flex-shrink-0 items-center justify-center text-white font-bold">
                    {user.name.charAt(0)}
                  </div>
                  <span className={cn(
